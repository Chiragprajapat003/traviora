    ...
    <div className="hidden md:flex flex-col fixed left-0 top-16 bottom-0 w-64 bg-[#050b14] border-r border-slate-800/60 z-40 overflow-y-auto">
      ...
      <div className="p-6 border-b border-slate-800/50">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <div className="text-pink-500 font-semibold text-sm">Traviora Premium</div>
      ...
      {/* SOS Button */}
      <div className="p-6">
        <button className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-lg border border-pink-500/30 bg-pink-500/10 text-pink-500 font-semibold text-sm hover:bg-pink-500/20 transition-colors cursor-pointer">
